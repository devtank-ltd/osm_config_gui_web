...
\begin{enumerate}
	...
	\item Press the reload symbol in `Status' to check whether your sensor has connected.
\end{enumerate}
...
You can update the OSM's firmware by pressing `Flash Firmware', once the firmware update has finished, the page will reload and you will have to reconnect. Check your version now matches the SHA in the table.
